...
import com.example.gan_image.databinding.EndingPlayingEnglishActivityBinding
...
class EndingPlayingEnglishActivity : AppCompatActivity() {
    val binding by lazy{ EndingPlayingEnglishActivityBinding.inflate(layoutInflater)}
