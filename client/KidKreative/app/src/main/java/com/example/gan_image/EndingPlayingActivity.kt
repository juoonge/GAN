...
import com.example.gan_image.databinding.EndingPlayingActivityBinding
...
class EndingPlayingActivity : AppCompatActivity() {
    val binding by lazy{ EndingPlayingActivityBinding.inflate(layoutInflater)}
